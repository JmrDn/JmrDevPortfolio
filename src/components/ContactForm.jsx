    ...
    return (
        <div className='max-w-[700px] my-8'>
            ...
            <form onSubmit={submitMessage} className='w-full' ref={ref}>
                ...
                <textarea required name='message' value={message} onChange={(e) => setMessage(e.target.value)} id='message' placeholder='Message' rows={4} className='w-full  border-2 p-4 rounded-lg  focus:border-[#00B2FF] focus:outline-none hover:border-[#00B2FF] my-2' />
                <button type='submit' className='group my-2 text-white bg-tertiary px-6 py-4 rounded-lg flex items-center hover:bg-[#37a1cf]  '>
