      ...
      <nav className='container mx-auto px-8 md:px-8 py-8 lg:px-[100px] flex justify-between items-center text-gray-500 '>
        ...
        <div className='flex'>
          <Link
            ...
            className={navWhere === 'home' ? `hidden lg:flex mr-14 cursor-pointer text-secondary` : `hidden lg:flex mr-14 cursor-pointer `}
          >Home</Link>
          <Link
            ...
            className={navWhere === 'about' ? `hidden lg:flex mr-14 cursor-pointer text-secondary` : `hidden lg:flex mr-14 cursor-pointer `}
          >About</Link>
          ...
          <Link
            ...
            className={navWhere === 'skill' ? `hidden lg:flex mr-14 cursor-pointer text-secondary` : `hidden lg:flex mr-14 cursor-pointer `}
          >Skills</Link>
          ...
          <Link
            ...
            className={navWhere === 'project' ? `hidden lg:flex mr-14 cursor-pointer text-secondary` : `hidden lg:flex mr-14 cursor-pointer `}
          >Projects</Link>
          <Link
            to="contact"
            spy={true}
      ...
      <nav className={`text-gray-500  w-full h-screen py-8 fixed top-0 right-0 z-50 bg-primary shadow-lg transition-all duration-1000 ease text-3xl md:text-6xl  ${isNavOpen ? `translate-x-0 opacity-100` : `translate-x-full opacity-0`}`}>
        ...
        <div className='flex flex-col w-full gap-y-6 text-center '>
          <Link
            ...
            className={navWhere === 'home' ? ` cursor-pointer text-secondary` : ` cursor-pointer `}
          >Home</Link>
          <Link
            ...
            onSetActive={() => handleActiveLink('about')}
            onClick={()=> setIsNavOpen(false)}
            className={navWhere === 'about' ? `cursor-pointer text-secondary` : `cursor-pointer`}
          >About</Link>
          ...
          <Link
            ...
            onSetActive={() => handleActiveLink('skill')}
            onClick={()=> setIsNavOpen(false)}
            className={navWhere === 'skill' ? `cursor-pointer text-secondary` : ` cursor-pointer`}
          >Skills</Link>
          ...
          <Link
            ...
            onSetActive={() => handleActiveLink('project')}
            onClick={()=> setIsNavOpen(false)}
            className={navWhere === 'project' ? ` cursor-pointer text-secondary` : `cursor-pointer `}
          >Projects</Link>
          <Link
            to="contact"
            spy={true}
            ...
            onSetActive={() => handleActiveLink('contact')}
            onClick={()=> setIsNavOpen(false)}
            className={navWhere === 'contact' ? `cursor-pointer text-secondary` : ` cursor-pointer `}
          >Contact</Link>
        </div>
      </nav>
    </div>
